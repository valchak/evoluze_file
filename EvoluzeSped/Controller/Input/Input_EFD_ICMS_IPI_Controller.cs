...
namespace EvoluzeSped.Controller.Input
{
    class Input_EFD_ICMS_IPI_Controller
    {
        ...
        Parametro_Sped_EFD_ICMS_IPI parametro;


        public Sped_EFD_ICMS_IPI GetObjetoSped(string arquivo, Parametro_Sped_EFD_ICMS_IPI parametros)
        {
        ...
        private bool validaRegistro(string linha)
        {
            try
            {
                ...
                {
                    case "0":
                        if (parametro.ParametroBloco0 != null)
                            processaBloco0(array[1], linha);
                        break;
                    case "1":
                        if (parametro.ParametroBloco1 != null)
                            processaBloco1(array[1], linha);
                        break;
                    case "B":
                        if (parametro.ParametroBlocoB != null)
                            processaBlocoB(array[1], linha);
                        break;
                    case "C":
                        if (parametro.ParametroBlocoC != null)
                            processaBlocoC(array[1], linha);
                        break;
                    case "D":
                        if (parametro.ParametroBlocoD != null)
                            processaBlocoD(array[1], linha);
                        break;
                    case "E":
                        if (parametro.ParametroBlocoE != null)
                            processaBlocoE(array[1], linha);
                        break;
                    case "G":
                        if (parametro.ParametroBlocoG != null)
                            processaBlocoG(array[1], linha);
                        break;
                    case "H":
                        if (parametro.ParametroBlocoH != null)
                            processaBlocoH(array[1], linha);
                        break;
                    case "K":
                        if (parametro.ParametroBlocoK != null)
                            processaBlocoK(array[1], linha);
                        break;
                    case "9":
                        if (parametro.ParametroBloco9 != null)
